...
export function ГолосПанель({
  ...
  return (
    <div>
      ...
      */}
      {!ретрансляторНастроен() && с.участники.some((u) => u.состояние === 'не вышло') && (
        <p className="mt-1 px-0.5 text-[11px] leading-snug text-amber-400">
          Звук идёт напрямую, без ретранслятора, и до части мобильных сетей не доходит. Кому не
          слышно — переключиться на Wi-Fi или раздать интернет с другого телефона.
        </p>
      )}
