  ...
  return (
    <div className="flex flex-col gap-3">
      <Блок имя="Поле и победа">
        ...
        />
        <Строка
          имя="Свобода на втором круге"
          знач={`доход ×${пр.freedomMultiple ?? 2} от расходов`}
          что="Рубеж на втором круге: его отмечают, но партию он не выигрывает. Победа одна — купить свою мечту"
        />
      </Блок>
