      ...
      {debtTotal > 0 && (
        <TradeBlock title="Я должен игрокам" accent="warn">
          <p className="mb-2 text-[12px] leading-snug">
            🔒 Пока долг не закрыт, <b>победа не засчитается</b> — ни мечтой, ни целью по доходу
            на Полосе свободы. Долг перед рассрочкой за актив тут ни при чём, речь только о
            деньгах, которые выручили люди.
          </p>
          {debts.map((ln) => {
        ...
        {!lender ? (
          ...
          <>
            <p className="mb-2 text-[12px] leading-snug text-[var(--muted)]">
              ...
              такую надбавку стол не даст ввести. Пока долг не закрыт, победа не засчитается.
            </p>
