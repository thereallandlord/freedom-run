        ...
        {onFast || noLoans ? (
          <p className="rounded-lg bg-emerald-500/10 px-3 py-2 text-sm text-emerald-300">
            {noLoans
               ...
               * что неприятности приходят чаще.
               */
              ? 'Здесь кредитов нет: крупное берётся в рассрочку прямо в сделке или с инвестором. Процентный кредит есть в окне «Сделки» — он даёт деньги быстро, но пока открыт, неприятности приходят чаще.'
