...
function отпечатокПравил(): string {
  ...
  const всё = JSON.stringify([
    ...
    'второйкруг:1',
    /*
     * 🔴 КАК РАСТУТ ТРАТЫ — ТОЖЕ ПРАВИЛО ПАРТИИ. 11.09 убран двойной рост трат
     * (+3% от дохода с активов каждую зарплату): журнал старой партии
     * переигрался бы с другими расходами. Меняешь, как растут траты, — увеличь число.
     */
    'образжизни:2',
    /*
     * 🔴 ПОЛОСА — ТОЖЕ ПРАВИЛО ПАРТИИ. 11.09 дела Полосы стали платить живыми
     * деньгами, просадка — резать их, клетка продажи ожила, подорожание чужой
     * мечты получило шаг и потолок. Меняешь, как идут деньги на Полосе, — увеличь число.
     */
    'полоса:2',
    /*
     * 🔴 СВОЁ ДЕЛО — ТОЖЕ ПРАВИЛО ПАРТИИ. 12.09 во франшизу своего дела больше
     * не нанять управляющего: журнал, где его наняли, переигрался бы иначе и
     * молча. Меняешь, что можно делать со своим делом, — увеличь число.
     */
    'своёдело:1',
    /*
