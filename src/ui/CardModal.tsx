        ...
        >
          ...
          <div className="rounded-lg bg-amber-500/10 px-3 py-3 text-center">
            ...
            <div className="mt-1 text-[12px] text-[var(--muted)]">
              выкуп на Полосу свободы — всё нажитое продано: за каждый объект большее из{' '}
              {RULES.fastTrackMultiplier} месячных потоков и рыночной цены, минус его рассрочка
              {!!p.бумаги && p.бумаги > 0 && <>, плюс бумаги по рынку на {money(p.бумаги)}</>}
            </div>
            {/*
            ...
            {!!p.долги && p.долги > 0 && (
              <div className="mt-2 border-t border-amber-500/30 pt-2 text-[12px] leading-snug text-[var(--muted)]">
                ...
                <span className="tabnum font-semibold text-[var(--ink)]">
                  {/*
                    🔴 Кламп стоял ВНУТРИ, до прибавки бумаг: если ведомость
                    больше объектной части выкупа, минус обрезался, а пакет
                    прибавлялся целиком — окно называло сумму больше той, что
                    легла на счёт. Замер: объект 1 000 000 ₽, пакет
