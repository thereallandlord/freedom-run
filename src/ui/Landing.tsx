...
export interface LandingProps {
   ...
   */
  устарела?: { ходов: number; onOk: () => void; изКабинета?: boolean }
  ...
  return (
    <div className="min-h-full">
      <div className="mx-auto w-full max-w-5xl px-4 pb-16 pt-5 sm:px-6">
        ...
        {/*
          🔴 Партия из кабинета показывается и при местном сохранении: человек
          только что нажал «поднять» и должен узнать, почему ничего не открылось.
        */}
        {устарела && !joinCode && (устарела.изКабинета || !saved) && (
          <div className="panel mb-4 rounded-2xl border-amber-500/40 bg-amber-500/5 p-4">
            <p className="text-sm leading-snug">
              {устарела.изКабинета ? 'Партия из кабинета' : 'Прошлая партия'} ({устарела.ходов} ходов)
              записана прежней версией игры — с тех пор изменились колоды или профессии.
              Восстановить её честно уже нельзя: карты и деньги пришли бы другие.
            </p>
