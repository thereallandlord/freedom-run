...
export interface Offer {
  ...
  share?: number
  /**
   * Для coInvest — складываемся НАЛОМ (на полную цену) или на взнос.
   *
   * 🔴 Раньше выбора не было вовсе: двое, у которых на руках вся цена, всё
   * равно получали объект с долгом и урезанным платежом потоком. На «Двушке
   * на Васильевском» это 33 200 ₽/мес вместо 87 500 — игра навязывала
   * рассрочку без всякой причины.
   */
  payCash?: boolean
