...
function checkFormulas() {
   ...
   */
  /*
   * 🔴 10.09.2026 — решение Камиля: траты профессий 60% зарплаты (было около
   * половины, «остаётся 150 тысяч — это много»). Числа ниже — новый баланс;
   * формула не менялась, поменялись данные.
   */
  const cases: [string, number, number][] = [
    ['teacher', 48000, 69000],
    ['nurse', 52000, 75000],
    ['courier', 52000, 74000],
    ['mechanic', 52000, 76000],
    ['accountant', 56000, 82000],
  ]
  let ok = true
